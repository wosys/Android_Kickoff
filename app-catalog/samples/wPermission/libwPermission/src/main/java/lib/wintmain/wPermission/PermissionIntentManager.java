...
final class PermissionIntentManager {
    ...
    static Intent getEmuiWindowPermissionPageIntent(Context context) {
        ...
        // android
        // 华为版本历史,一文看完华为EMUI发展史：https://blog.csdn.net/weixin_39959369/article/details/117351161
        ...
        if (romVersionName.startsWith("3.0")) {
            ...
            if (PermissionUtils.areActivityIntent(context, addViewMonitorActivityIntent)) {
                intent =
                        StartActivityManager.addSubIntentToMainIntent(
        ...
        if (PermissionUtils.areActivityIntent(context, huaWeiMobileManagerAppIntent)) {
            intent =
                    StartActivityManager.addSubIntentToMainIntent(
                            intent, huaWeiMobileManagerAppIntent);
        }
    ...
    static Intent getColorOsWindowPermissionPageIntent(Context context) {
        ...
        // 经过测试发现是在 ColorOs 2.1 的时候改的，Android 4.4 还是 com.color.safecenter，到了 Android 5.0 变成了
        // com.oppo.safe

        // java.lang.SecurityException: Permission Denial: starting Intent
        // { cmp=com.oppo.safe/.permission.floatwindow.FloatWindowListActivity (has extras) } from
        // ProcessRecord{839a7c5 10595:com.hjq.permissions.demo/u0a3781} (pid=10595, uid=13781) not
        // exported from uid 1000
        // intent.setClassName("com.oppo.safe",
        // "com.oppo.safe.permission.floatwindow.FloatWindowListActivity");

        // java.lang.SecurityException: Permission Denial: starting Intent
        // { cmp=com.color.safecenter/.permission.floatwindow.FloatWindowListActivity (has extras) }
        // from
        // ProcessRecord{42b660b0 31279:com.hjq.permissions.demo/u0a204} (pid=31279, uid=10204) not
        // exported from uid 1000
        // intent.setClassName("com.color.safecenter",
        // "com.color.safecenter.permission.floatwindow.FloatWindowListActivity");

        // java.lang.SecurityException: Permission Denial: starting Intent
        // { cmp=com.color.safecenter/.permission.PermissionAppAllPermissionActivity (has extras) }
        // from
        // ProcessRecord{42c49dd8 1791:com.hjq.permissions.demo/u0a204} (pid=1791, uid=10204) not
        // exported from uid 1000
        // intent.setClassName("com.color.safecenter",
        // "com.color.safecenter.permission.PermissionAppAllPermissionActivity");
        ...
        Intent permissionTopActivityActionIntent =
                new Intent("com.oppo.safe.permission.PermissionTopActivity");
    ...
    static Intent getOriginOsWindowPermissionPageIntent(Context context) {
        ...
        // ProcessRecord{2c3023cf 21847:com.hjq.permissions.demo/u0a4633} (pid=21847, uid=14633) not
        // exported from uid 10055
    ...
    static Intent getMiuiPermissionPageIntent(Context context) {
        ...
        if (PermissionUtils.areActivityIntent(context, xiaoMiMobileManagerAppIntent)) {
            intent =
                    StartActivityManager.addSubIntentToMainIntent(
                            intent, xiaoMiMobileManagerAppIntent);
        }
    ...
    static Intent getOneUiPermissionPageIntent(Context context) {
        ...
        intent.setClassName(
                "com.android.settings", "com.android.settings.Settings$AppOpsDetailsActivity");
    ...
    static Intent getHuaWeiMobileManagerAppIntent(Context context) {
        Intent intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(EMUI_MOBILE_MANAGER_APP_PACKAGE_NAME);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        return null;
    ...
    static Intent getXiaoMiMobileManagerAppIntent(Context context) {
        Intent intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(MIUI_MOBILE_MANAGER_APP_PACKAGE_NAME);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        return null;
    ...
    static Intent getOppoSafeCenterAppIntent(Context context) {
        Intent intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(COLOR_OS_SAFE_CENTER_APP_PACKAGE_NAME_1);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(COLOR_OS_SAFE_CENTER_APP_PACKAGE_NAME_2);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(COLOR_OS_SAFE_CENTER_APP_PACKAGE_NAME_3);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        return null;
    ...
    static Intent getVivoMobileManagerAppIntent(Context context) {
        Intent intent =
                context.getPackageManager()
                        .getLaunchIntentForPackage(ORIGIN_OS_MOBILE_MANAGER_APP_PACKAGE_NAME);
        if (PermissionUtils.areActivityIntent(context, intent)) {
            return intent;
        }
        return null;
