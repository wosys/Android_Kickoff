 ...
 * file located at:
 *
 *   hello-jniCallback/app/src/main/java/com/wintmain/hellojnicallback/JniCallbackMainActivity.java
 */
JNIEXPORT jstring JNICALL
Java_com_wintmain_hellojnicallback_JniCallbackMainActivity_stringFromJNI(JNIEnv *env,
                                                                         jobject thiz) {
#if defined(__arm__)
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz =
            (*env)->FindClass(env, "com/wintmain/hellojnicallback/JniHandler");
...
Java_com_wintmain_hellojnicallback_JniCallbackMainActivity_startTicks(JNIEnv *env,
                                                                      jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_wintmain_hellojnicallback_JniCallbackMainActivity_StopTicks(JNIEnv *env,
                                                                     jobject instance) {
