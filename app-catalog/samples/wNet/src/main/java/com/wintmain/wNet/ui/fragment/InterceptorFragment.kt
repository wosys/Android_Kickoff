...
import com.wintmain.wNet.databinding.FragmentInterceptorBinding
...
class InterceptorFragment :
    ...
    override fun initView() {
        scopeNetLife {
            binding.tvFragment.text = Get<String>(com.wintmain.wNet.constants.Api.TEXT) {
                // 拦截器只支持全局, 无法单例, 请查看[com.wintmain.wNet.interceptor.NetInterceptor]
            }.await()
        }
    }
