...
import com.wintmain.wNet.databinding.FragmentFastestBinding
import lib.wintmain.libwNet.Get
import lib.wintmain.libwNet.Post
import lib.wintmain.libwNet.utils.fastest
    ...
    override fun initView() {
        scopeNetLife {
            ...
            */
            ...
            // 同时发起四个网络请求
            val deferred2 = Get<String>(com.wintmain.wNet.constants.Api.TEXT) { setGroup("最快") }
