...
public class BasePopupWindow extends PopupWindow
    ...
    /** 设置销毁监听器集合 */
    private void setOnDismissListeners(
            @Nullable List<BasePopupWindow.OnDismissListener> listeners) {
        super.setOnDismissListener(this);
    ...
    public static class Builder<T extends BasePopupWindow.Builder<?>>
        ...
        public T setAnimStyle(@StyleRes int id) {
            mAnimations = id;
            if (isCreated()) {
        ...
        /** 设置水平偏移量 */
        public T setXOffset(int offset) {
            mXOffset = offset;
            return (T) this;
        }

        /** 设置垂直偏移量 */
        public T setYOffset(int offset) {
            mYOffset = offset;
            return (T) this;
        }
        ...
        /** 设置创建监听 */
        public T setOnCreateListener(@NonNull BasePopupWindow.OnCreateListener listener) {
            mCreateListener = listener;
            return (T) this;
        }

        /** 添加显示监听 */
        public T addOnShowListener(@NonNull BasePopupWindow.OnShowListener listener) {
            mShowListeners.add(listener);
            return (T) this;
        }

        /** 添加销毁监听 */
        public T addOnDismissListener(@NonNull BasePopupWindow.OnDismissListener listener) {
            mDismissListeners.add(listener);
            return (T) this;
        }

        /** 设置文本 */
        public T setText(@IdRes int viewId, @StringRes int stringId) {
            return setText(viewId, getString(stringId));
        }

        public T setText(@IdRes int id, CharSequence text) {
            ((TextView) findViewById(id)).setText(text);
            return (T) this;
        }

        /** 设置文本颜色 */
        public T setTextColor(@IdRes int id, @ColorInt int color) {
            ((TextView) findViewById(id)).setTextColor(color);
            return (T) this;
        }

        /** 设置提示 */
        public T setHint(@IdRes int viewId, @StringRes int stringId) {
            return setHint(viewId, getString(stringId));
        }

        public T setHint(@IdRes int id, CharSequence text) {
            ((TextView) findViewById(id)).setHint(text);
            return (T) this;
        }

        /** 设置可见状态 */
        public T setVisibility(@IdRes int id, int visibility) {
            findViewById(id).setVisibility(visibility);
            return (T) this;
        }

        /** 设置背景 */
        public T setBackground(@IdRes int viewId, @DrawableRes int drawableId) {
            return setBackground(viewId, ContextCompat.getDrawable(mContext, drawableId));
        }

        public T setBackground(@IdRes int id, Drawable drawable) {
            findViewById(id).setBackground(drawable);
            return (T) this;
        }

        /** 设置图片 */
        public T setImageDrawable(@IdRes int viewId, @DrawableRes int drawableId) {
            return setBackground(viewId, ContextCompat.getDrawable(mContext, drawableId));
        }

        public T setImageDrawable(@IdRes int id, Drawable drawable) {
            ((ImageView) findViewById(id)).setImageDrawable(drawable);
            return (T) this;
        }

        /** 设置点击事件 */
        public T setOnClickListener(
                @IdRes int id, @NonNull BasePopupWindow.OnClickListener<?> listener) {
            if (mClickArray == null) {
            ...
            for (int i = 0; mClickArray != null && i < mClickArray.size(); i++) {
                ...
                if (view != null) {
                    view.setOnClickListener(
                            new BasePopupWindow.ViewClickWrapper(
                                    mPopupWindow, mClickArray.valueAt(i)));
                }
            }
        ...
        /** 设置布局 */
        public T setContentView(@LayoutRes int id) {
    ...
    private static class PopupBackground
            implements BasePopupWindow.OnShowListener, BasePopupWindow.OnDismissListener {
